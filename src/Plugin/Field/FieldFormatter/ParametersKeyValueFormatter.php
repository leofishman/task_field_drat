...
/**
 * Plugin implementation of the 'task_field_parameters_key_value' formatter.
 *
 * @FieldFormatter(
 *   id = "task_field_parameters_key_value",
 *   label = @Translation("Key-value"),
 *   field_types = {"task_field_parameters"},
 * )
 */
final class ParametersKeyValueFormatter extends FormatterBase {
